                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_hukuman/rubah/'.$id, 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>  
                                    <input type="text" name="enabledhuk" class="form-control" value="<?= $huk['status_aktif'] ?>" hidden>
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="hukumanj" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Jenis Hukuman">
                                                    <?php foreach ($mjhukuman as $mjh) : ?>
                                                        <option value="<?= $mjh['id_jenis_hukuman'] ?>" <?= $huk['jhukuman_id']==$mjh['id_jenis_hukuman'] ? 'selected' : '' ?>><?= $mjh['jenis_hukuman'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="hukumannm" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Jenis Hukuman">
                                                    <?php foreach ($mhukuman as $mh) : ?>
                                                        <option value="<?= $mh['id_hukuman'] ?>" <?= $huk['hukuman_id']==$mh['id_hukuman'] ? 'selected' : '' ?>><?= $mh['nm_hukuman'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="nosk_huk" class="form-control" value="<?= $huk['no_sk'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tglsk_huk" class="form-control" id="tglsk_huk" value="<?= isset($huk['tgl_sk']) ? date('d-m-Y', strtotime($huk['tgl_sk'])) : '' ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="mh_bln" class="form-control" value="<?= $huk['masa_hukuman_bulan'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Masa Hukuman (Tahun)</label>
                                        <div class="col-md-10">
                                            <input type="text" name="mh_thn" class="form-control" value="<?= $huk['masa_hukuman_tahun'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="hukumantmt" class="form-control" id="hukumantmt"  value="<?= isset($huk['tmt_hukuman']) ? date('d-m-Y', strtotime($huk['tmt_hukuman'])) : '' ?>">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="nosk_batal_huk" class="form-control" value="<?= $huk['no_sk_pembatalan'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tglsk_batal_huk" class="form-control" id="tglsk_batal_huk"  value="<?= isset($huk['tgl_sk_pembatalan']) ? date('d-m-Y', strtotime($huk['tgl_sk_pembatalan'])) : '' ?>">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="alasan_huk"  class="form-control h-100" rows="3" ><?= $huk['alasan_hukuman'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default ">
                                        <label>File SK Hukuman <small class="text-danger">[pdf | Max 300Kb]</small></label>
                                        <p><i><?= isset($huk['file_sk_hukuman']) && file_exists('assets/asn/dokumen/arsip/'.$huk['file_sk_hukuman']) ? $huk['file_sk_hukuman'] : 'Belum ada File SK Hukuman' ?></i></p>
                                        <input type="file" class="form-control-file" name="file_sk_hukuman" value="<?= $huk['file_sk_hukuman'] ?>">
                                    </div>
                                    <div class="form-group form-group-default ">
                                        <label>File SK Pembatalan Hukuman <small class="text-danger">[pdf | Max 300Kb]</small></label>
                                        <p><i><?= isset($huk['file_sk_pembatalan_hukuman']) && file_exists('assets/asn/dokumen/arsip/'.$huk['file_sk_pembatalan_hukuman']) ? $huk['file_sk_pembatalan_hukuman'] : 'Belum ada File SK Hukuman' ?></i></p>
                                        <input type="file" class="form-control-file" name="file_sk_pembatalan_hukuman" value="<?= $huk['file_sk_pembatalan_hukuman'] ?>">
                                    </div>
                                    <br>
                                    <div class="row">
                                        <!-- <div class="col-md-3">
