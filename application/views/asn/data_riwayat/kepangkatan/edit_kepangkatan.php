...
<body class="fixed-header menu-pin">
                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_pangkat/rubah/'.$id, 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    <input type="text" name="enabled" class="form-control" value="<?= $mp['status_aktif'] ?>" hidden>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Nomor SK</label>
                                        <div class="col-md-10">
                                            <input type="text" name="nomorsk" class="form-control" value="<?= $mp['sk_nomor'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tanggalsk" class="form-control" id="tglsk" value="<?= $mp['sk_tanggal'] ? date('d-m-Y', strtotime($mp['sk_tanggal'])) : '' ?>">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 ">Nomor BAKN</label>
                                        <div class="col-md-10">
                                            <input type="text" name="nobakn" class="form-control" value="<?= $mp['no_bakn'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 ">Tanggal BAKN</label>
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tglbakn" class="form-control" id="tglbkn" value="<?= $mp['tgl_bakn'] ? date('d-m-Y', strtotime($mp['tgl_bakn'])) : '' ?>">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-10">
                                            <select class="full-width select2-hidden-accessible" name="golongan" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Golongan">
                                                    <?php foreach ($mgolongan as $mg) : ?>
                                                        <option value="<?= $mg['id_golongan'] ?>" <?= $mp['golongan_id']==$mg['id_golongan'] ? 'selected' : '' ?>><?= $mg['golongan'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <select class="full-width select2-hidden-accessible" name="kepangkatan" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                <option value="">--- Pilih ---</option>
                                                <optgroup label="Pilih Jenis">
                                                    <?php foreach ($mkepangkatan as $kp) : ?>
                                                        <option value="<?= $kp['id_kepangkatan'] ?>" <?= $mp['kepangkatan_id']==$kp['id_kepangkatan'] ? 'selected' : '' ?>><?= $kp['nm_kepangkatan'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    </div>
                                    <div id="tupoks" class="form-group row">
                                        <label class="col-md-2 ">TMT Pangkat</label>
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tmtpangkat" class="form-control" id="tmtpangkat" value="<?= $mp['tmt_pangkat'] ? date('d-m-Y', strtotime($mp['tmt_pangkat'])) : '' ?>">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 ">Masa Kerja Golongan (Tahun)</label>
                                        <div class="col-md-10">
                                            <input type="text" name="mkg_thn" class="form-control" id="gthn" value="<?= $mp['masa_kerja_golongan_tahun'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 ">Masa Kerja Golongan (Bulan)</label>
                                        <div class="col-lg-5">
                                            <input type="text" name="mkg_bln" class="form-control" id="gbln" value="<?= $mp['masa_kerja_golongan_bulan'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 ">Pejabat yang menetapkan</label>
                                        <div class="col-lg-5">
                                            <input type="text" name="pejabatpenetap" class="form-control" value="<?= $mp['pejabat_penetap'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default ">
                                        <label>File SK Kepangkatan <small class="text-danger">[pdf | Max 500Kb]</small></label>
                                        <p><i><?= isset($mp['file_sk_pangkat']) ? $mp['file_sk_pangkat'] : 'Belum ada File SK Kepangkatan';  ?></i></p>
  ...
  `  <script src="<?= base_url(); ?>assets/asn/plugins/modernizr.custom.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(function($) {
            $("#tmtpangkat").mask("99-99-9999");
            $("#tglsk").mask("99-99-9999");
            $("#tglbkn").mask("99-99-9999");
        });
