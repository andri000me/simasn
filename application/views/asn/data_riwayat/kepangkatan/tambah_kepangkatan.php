                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_pangkat/tambah', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tanggalsk" class="form-control" id="tglsk" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="nobakn" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tglbakn" class="form-control" id="tglbkn" required>
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="kepangkatan" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Jenis">
                                                    <?php foreach ($mkepangkatan as $kp) : ?>
                                                        <option value="<?= $kp['id_kepangkatan'] ?>"><?= $kp['nm_kepangkatan'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div id="tupoks" class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tmtpangkat" class="form-control" id="tmtpangkat">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="mkg_thn" class="form-control" id="gthn" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 ">Masa Kerja Golongan (Bulan)</label>
                                        <div class="col-lg-5">
                                            <input type="text" name="mkg_bln" class="form-control" id="gbln" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 ">Pejabat yang menetapkan</label>
                                        <div class="col-lg-5">
                                            <input type="text" name="pejabatpenetap" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default ">
                                        <label>File SK Kepangkatan <small class="text-danger">[pdf | Max 500Kb]</small></label>
                                        <p><i>Belum ada File SK Kepangkatan</i></p>
