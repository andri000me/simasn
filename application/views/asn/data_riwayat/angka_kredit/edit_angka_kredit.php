                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_kredit/rubah/'.$id, 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    <input type="text" name="enabledkr" class="form-control" value="<?= $kr['status_aktif'] ?>" hidden>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Kredit Utama Baru</label>
                                        <div class="col-md-9">
                                            <input type="text" name="utamakredit" class="form-control" value="<?= $kr['kredit_utama'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Kredit Penungjang Baru</label>
                                        <div class="col-md-9">
                                            <input type="text" name="tunjangkredit" class="form-control" value="<?= $kr['kredit_penunjang'] ?>" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="awaltgl" class="form-control" id="tglawal" value="<?= isset($kr['tgl_awal']) ? date('d-m-Y', strtotime($kr['tgl_awal'])):'' ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="akhirtgl" class="form-control" id="tglakhir" value="<?= isset($kr['tgl_akhir']) ? date('d-m-Y', strtotime($kr['tgl_akhir'])):'' ?>">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="sktglkredit" class="form-control" id="tglskkredit" value="<?= isset($kr['tgl_sk']) ? date('d-m-Y', strtotime($kr['tgl_sk'])):'' ?>">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="sknomor" class="form-control" value="<?= $kr['no_sk'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="jabatan" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Jabatan">
                                                    <?php foreach ($mjabatan as $j) : ?>
                                                        <option value="<?= $j['id_jabatan'] ?>" <?= $kr['jabatan_id']==$j['id_jabatan'] ? 'selected' : '' ?>><?= $j['nm_jabatan'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group form-group-default ">
                                        ...
                                        <p><i><?= isset($kr['file_sk_kredit']) ? $kr['file_sk_kredit'] : 'Belum ada File SK PAK Kredit' ?></i></p>
                                        <input type="file" class="form-control-file" name="file_skkredit" value="<?= $kr['file_sk_kredit'] ?>">
                                    </div>
                                    <br>
                                    <div class="row">
                                        <!-- <div class="col-md-3">
