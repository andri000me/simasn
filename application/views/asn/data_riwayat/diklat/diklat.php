                    ...
                    <div class="card card-transparent">
                        <div class="card-header  d-flex justify-content-between">
                            ...
                            <div class="pull-right">
                                <div class="col-xs-12">
                                    <a href="<?= base_url("data_riwayat/diklat/tambah_diklat")?>" type="button" class="btn btn-info btn-cons"><i class="fa fa-plus"></i> Tambah</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-hover" id="tableWithExportOptions">
                                <thead class="bg-info-lighter">
                                    <tr>
                                        ...
                                        <th class="text-black">Jenis Diklat</th>
                                        <th class="text-black">Nama Diklat</th>
                                        <th class="text-black">Penyelenggara</th>
                                        <th class="text-black">Jumlah Jam</th>
                                        <th class="text-black">Nomor Sertifikat</th>
                                        <th class="text-black">Tanggal Sertifikat</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= isset($d['tgl_sertifikat']) ? date('d-m-Y', strtotime($d['tgl_sertifikat'])) : '' ?></td>
                                        <td>
                                            <?php if($d['status_aktif'] != 1): ?>
                                                <?php if($d['validator_moddiklat']==1): ?>
                                                    ...
                                                    <?php else:?>
                                                        <a href="#" data-toggle="modal" data-target="#valdi<?= $d['id'] ?>"><span class="bg-danger text-center text-white p-1 text-nowrap rounded"> Gagal Validasi Tahap 1 </span></a>
                                                    <?php endif;?>
                                                <?php elseif($d['validator_moddiklat']==2):?>
                                                    <?php if($d['status_validasi_moddiklat'] ==1):?>
                                                        <span class="bg-warning text-center text-white p-1 text-nowrap rounded"> Validasi Tahap 2 BKPSDM </span>
                                                    <?php else:?>
                                                        <a href="#" data-toggle="modal" data-target="#valdi<?= $d['id'] ?>"><span class="bg-danger text-center text-white p-1 text-nowrap rounded"> Gagal Validasi Tahap 2 </span></a>
                                                    <?php endif;?>
                                                <?php else: ?>
                                                    <a href="#" data-toggle="modal" data-target="#valdi<?= $d['id'] ?>"><span class="bg-danger text-center text-white p-1 text-nowrap rounded"> Ditolak </span></a>
                                                <?php endif; ?>
                                            <?php else:?>
                                        ...
                                        <td>
                                            <a <?= $d['status_validasi_moddiklat']==0 || $d['status_validasi_moddiklat']==1 && $d['status_aktif']==1 ? 'href="'.base_url("data_riwayat/diklat/ubah_diklat/".encrypt_url($d['id'])).'"':'href="#"  data-toggle="modal" data-target="#msgdk'.$d['id'].'"';?> type="button" class="btn-xs btn-info"><i class="fa fa-pencil"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#apusdik<?= $d['id'] ?>" type="button" class="btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <div class="modal fade slide-up disable-scroll" id="valdi<?= $d['id'] ?>" tabindex="-1" role="dialog" aria-hidden="false">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content-wrapper">
                                                <div class="modal-content" style="background-color: #e2e2e2;">
                                                    <div class="modal-body text-center m-t-20">
                                                        <h6 class="no-margin p-b-10"><b>Keterangan Validasi : </b> <?= $d['ket_validasi_moddiklat']; ?></h6>
                                    ...
                                    <div class="modal fade slide-up disable-scroll" id="msgdk<?=$d['id']?>" tabindex="-1" role="dialog" aria-hidden="false">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content-wrapper">
                                                <div class="modal-content" style="background-color: #e2e2e2;">
                                                    <div class="modal-body text-center m-t-20">
                                                        <h6 class="no-margin p-b-10">Data sementara dalam proses validasi tahap <?= $d['validator_moddiklat'] ?>, Data tdiak bisa diedit</h6>
                                                        <button type="button" class="btn btn-xs btn-success btn-cons" data-dismiss="modal">Tutup</button>
                                    ...
                                    <div class="modal fade slide-up disable-scroll" id="apusdik<?= $d['id'] ?>" tabindex="-1" role="dialog" aria-hidden="false">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content-wrapper">
                                                <div class="modal-content" style="background-color: #e2e2e2;">
                                                    <div class="modal-body text-center m-t-20">
                                                        <h6 class="no-margin p-b-10">Apa anda yakin inginmenghapus data ini ? !!!</h6>
                                                        <a href="<?= base_url('data_riwayat/hapus_diklat/'.encrypt_url($d['id'])) ?>" type="button" class="btn btn-xs btn-success btn-cons  pull-left inline">Ya</a>
