                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_diklat/tambah', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="jenisdiklat" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Jenis">
                                                    <?php foreach ($mjdiklat as $mj) : ?>
                                                        <option value="<?= $mj['id_jenis_diklat'] ?>"><?= $mj['jenis_diklat'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 ">Diklat</label>
                                        <div class="col-md-10">
                                            <select class="full-width select2-hidden-accessible" name="diklat" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Jenis">
                                                    <?php foreach ($mdiklat as $md) : ?>
                                                        <option value="<?= $md['id_diklat'] ?>"><?= $md['nm_diklat'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="diklatnm" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Penyelenggara</label>
                                        <div class="col-md-10">
                                            <input type="text" name="pihakpenyelenggara" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="sertifikatno" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="sertifikattgl" class="form-control" id="tglsertifikat" required>
                                    ...
                                    <div class="form-group form-group-default ">
                                        ...
                                        <input type="file" class="form-control-file" name="file_sertifikatd">
                                    </div>
                                    <br>
                                    <div class="row">
                                        <!-- <div class="col-md-3">
