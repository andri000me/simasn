                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_penghargaan/tambah', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    
                                    <div class="form-group row">
                                        <label  class="col-md-3">Nama Penghargaan / Tanda Jasa</label>
                                        <div class="col-md-9">
                                            <input type="text" name="penghargaannm" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Nama Lembaga Pemberi</label>
                                        <div class="col-md-9">
                                            <input type="text" name="lbgpemberi" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Pejabat Penetap</label>
                                        <div class="col-md-9">
                                            <input type="text" name="pejabatnm" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Nomor SK</label>
                                        <div class="col-md-9">
                                            <input type="text" name="skno" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="sktgl" class="form-control" id="tglsk" required>
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default ">
                                        <label>File Serifikat/Piagam Penghargaan <small class="text-danger">[pdf | Max 500Kb]</small></label>
                                        <p><i>Belum ada File Sertifikat/Piagam Penghargaan</i></p>
                                        <input type="file" class="form-control-file" name="file_penghargaansk">
                                    </div>
                                    <br>
                                    <div class="row">
                                        <!-- <div class="col-md-3">
