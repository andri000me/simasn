                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_seminar/tambah', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Nama Seminar</label>
                                        <div class="col-md-10">
                                            <input type="text" name="nmseminar" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Penyelenggara</label>
                                        <div class="col-md-10">
                                            <input type="text" name="selenggarapihak" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="seminartgl" class="form-control" id="tglseminar" required>
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="peran" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Peran">
                                                    <?php foreach ($mseminar as $ms) : ?>
                                                        <option value="<?= $ms['id_peranan'] ?>"><?= $ms['nm_peranan'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="totjam" class="form-control" required="">
                                        </div>
                                    </div>
