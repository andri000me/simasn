                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_seminar/rubah/'.$id, 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    <input type="text" name="enabledsmr" class="form-control" value="<?= $sr['status_aktif'] ?>" hidden>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Nama Seminar</label>
                                        <div class="col-md-10">
                                            <input type="text" name="nmseminar" class="form-control" value="<?= $sr['nm_seminar'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Penyelenggara</label>
                                        <div class="col-md-10">
                                            <input type="text" name="selenggarapihak" class="form-control" value="<?= $sr['penyelenggara'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2 ">Tanggal Seminar</label>
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="seminartgl" class="form-control" id="tglseminar" value="<?= isset($sr['tgl_seminar']) ? date('d-m-Y', strtotime($sr['tgl_seminar'])) : '' ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <select class="full-width select2-hidden-accessible" name="peran" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                <option value="">--- Pilih ---</option>
                                                <optgroup label="Pilih Peran">
                                                    <?php foreach ($mseminar as $ms) : ?>
                                                        <option value="<?= $ms['id_peranan'] ?>" <?= $sr['peranan_id'] == $ms['id_peranan'] ? 'selected' : '' ?>><?= $ms['nm_peranan'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="totjam" class="form-control" value="<?= $sr['jam_seminar'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default ">
                                        <label>File Sertifikat <small class="text-danger">[pdf | Max 300Kb]</small></label>
                                        <p><i><?= !empty($sr['file_sertifikat_seminar']) && file_exists('assets/asn/dokumen/arsip/'.$sr['file_sertifikat_seminar'])  ? $sr['file_sertifikat_seminar'] : 'Belum ada File Sertifikat' ?></i></p>
                                        <input type="file" class="form-control-file" name="file_sertifikats" value="<?= $sr['file_sertifikat_seminar'] ?>">
                                    </div>
                                    <br>
                                    <div class="row">
                                        <!-- <div class="col-md-3">
