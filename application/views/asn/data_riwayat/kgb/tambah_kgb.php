                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_kgb/tambah', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tglskkgb" class="form-control" id="tglsk" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="kgbtmt" class="form-control" id="kgbtmt" required>
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="mkkthn" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Masa Kerja KGB (bulan)</label>
                                        <div class="col-md-10">
                                            <input type="text" name="mkkbln" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Gaji Pokok</label>
                                        <div class="col-md-10">
                                            <input type="text" name="pokokgaji" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Gaji Bersih</label>
                                        <div class="col-md-10">
                                            <input type="text" name="bersihgaji" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default ">
                                        <label>File SK KGB <small class="text-danger">[pdf | Max 500Kb]</small></label>
                                        <p><i>Belum ada File SK KGB</i></p>
