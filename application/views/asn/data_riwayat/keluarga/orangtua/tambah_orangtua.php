                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_orangtua/tambah', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="orangtuaid" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Status Orangtua">
                                                    <?php foreach($mkeluarga as $o): ?>
                                                        <option value="<?= $o['id_orangtua'] ?>"><?= $o['nm_orangtua'] ?></option>
                                                    <?php endforeach;?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="orangtuanm" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Tempat Lahir</label>
                                        <div class="col-md-9">
                                            <input type="text" name="orangtuatl" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="orangtuatgll" class="form-control" id="tgllahir" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="orangtuaalamat" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Pekerjaan</label>
                                        <div class="col-md-9">
                                            <input type="text" name="orangtuapekerjaan" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select class="full-width select2-hidden-accessible" name="statusdasar" data-init-plugin="select2" tabindex="-1" onchange="getstatus($(this).val())" aria-hidden="true">
                                                ...
                                                <?php foreach($mstatusdasar as $ms): ?>
                                                    <option value="<?= $ms['id_status_dasar'] ?>"> <?= $ms['status_dasar'] ?> </option>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
                                    </div>
                                    <div id="smeninggal" hidden>
                                        <div class="form-group row">
                                            <label class="col-md-3 ">Tanggal Meninggal</label>
                                            <div class="col-md-9">
                                                <div id="datepicker-component" class="input-group date">
                                                    <input type="text" name="orangtuatglm" class="form-control" id="tglmeninggal" required>
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="orangtuameninggalnokate" class="form-control" required="">
                                                <small class="text-danger"><i>Hanya diisi jika orang tua sudah meninggal</i></small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default mt-2">
                                        ...
                                        <p><i>Belum ada File Kartu Keluarga</i></p>
                                        <input type="file" class="form-control-file" name="file_orangtua">
                                    </div>
                                    <br>
                                    <div class="row">
                                        <!-- <div class="col-md-3">
