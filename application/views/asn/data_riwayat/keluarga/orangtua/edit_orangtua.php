                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_orangtua/rubah/'.$id, 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    <input type="text" name="enabledortu" class="form-control" value="<?= $mgk['status_aktif'] ?>" hidden>   
                                    <div class="form-group row">
                                        <label class="col-md-3 ">Status Orang Tua</label>
                                        <div class="col-md-9">
                                            <select class="full-width select2-hidden-accessible" name="orangtuaid" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                <option value="">--- Pilih ---</option>
                                                <optgroup label="Pilih Status Orangtua">
                                                    <?php foreach($mkeluarga as $o): ?>
                                                        <option value="<?= $o['id_'.$uri] ?>" <?= $mgk[$uri.'_id']==$o['id_'.$uri] ? 'selected' : '' ?>><?= $o['nm_'.$uri] ?></option>
                                                    <?php endforeach;?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Nama Orangtua</label>
                                        <div class="col-md-9">
                                            <input type="text" name="orangtuanm" class="form-control" value="<?= $mgk['nama'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Tempat Lahir</label>
                                        <div class="col-md-9">
                                            <input type="text" name="orangtuatl" class="form-control"  value="<?= $mgk['tempatlahir'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="orangtuatgll" class="form-control" id="tgllahir" value="<?= isset($mgk['tanggallahir']) && !empty($mgk['tanggallahir']) ? date('d-m-Y', strtotime($mgk['tanggallahir'])) : '' ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="orangtuaalamat" class="form-control" value="<?= $mgk['alamat'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Pekerjaan</label>
                                        <div class="col-md-9">
                                            <input type="text" name="orangtuapekerjaan" class="form-control" value="<?= $mgk['pekerjaan'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div id="smeninggal" <?= !isset($mgk['no_akte_meninggal']) || empty($mgk['no_akte_meninggal']) ? 'hidden' : '' ?>>
                                        <div class="form-group row">
                                            <label class="col-md-3 ">Tanggal Meninggal</label>
                                            <div class="col-md-9">
                                                <div id="datepicker-component" class="input-group date">
                                                    <input type="text" name="orangtuatglm" class="form-control" id="tglmeninggal" value="<?= isset($mgk['tanggalmeninggal']) && !empty($mgk['tanggalmeninggal']) ? date('d-m-Y', strtotime($mgk['tanggalmeninggal'])) : '' ?>">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                </div>
                                                <small class="text-danger"><i>Hanya diisi jika orang tua sudah meninggal</i></small>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label  class="col-md-3 ">Nomor Akte Mneinggal</label>
                                            <div class="col-md-9">
                                                <input type="text" name="orangtuameninggalnokate" class="form-control" value="<?= $mgk['no_akte_meninggal'] ?>">
                                                <small class="text-danger"><i>Hanya diisi jika orang tua sudah meninggal</i></small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default mt-2">
                                        <label>File Kartu Keluarga <small class="text-danger">[pdf | Max 500Kb] </small></label>
                                        <p><i><?= !empty($mgk['file_kartu_keluarga']) && file_exists('assets/asn/dokumen/arsip/'.$mgk['file_kartu_keluarga'])  ? $mgk['file_kartu_keluarga'] : 'Belum ada File Kartu Keluarga' ?></i></p>
                                        <input type="file" class="form-control-file" name="file_orangtua" value="<?= $mgk['file_kartu_keluarga'] ?>">
                                    </div>
                                    <br>
                                    <div class="row">
                                        <!-- <div class="col-md-3">
