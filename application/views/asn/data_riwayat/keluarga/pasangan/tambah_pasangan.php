                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_pasangan/tambah', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="pasangan" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Status pasangan">
                                                    <?php foreach($mkeluarga as $o): ?>
                                                        <option value="<?= $o['id_pasangan'] ?>"><?= $o['nm_pasangan'] ?></option>
                                                    <?php endforeach;?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="pasangannm" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Tempat Lahir</label>
                                        <div class="col-md-9">
                                            <input type="text" name="pasangantl" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="pasangantgll" class="form-control" id="tgllahir" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="pasangantgln" class="form-control" id="tglnikah" required>
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="pasanganaktenikah" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">NIP Pasangan</label>
                                        <div class="col-md-9">
                                            <input type="text" name="pasangannip" class="form-control">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="pasanganpekerjaan" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div id="bercerai" hidden>
                                        <div class="form-group row">
                                            <label  class="col-md-3 ">Nomor Akte Cerai</label>
                                            <div class="col-md-9">
                                                <input type="text" name="pasanganaktecerai" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div id="datepicker-component" class="input-group date">
                                                    <input type="text" name="pasangantglc" class="form-control" id="tglcerai">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                </div>
                                                <small class="text-danger"><i>Hanya diisi jika sudah bercerai</i></small>
                                            </div>
                                    ...
                                    <div id="smeninggal" hidden>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="pasanganmeninggalnokate" class="form-control">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div id="datepicker-component" class="input-group date">
                                                    <input type="text" name="pasangantglm" class="form-control" id="tglmeninggal">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                </div>
                                                <small class="text-danger"><i>Hanya diisi jika pasangan sudah meninggal</i></small>
                                            </div>
                                    ...
                                    <div class="form-group form-group-default mt-2">
                                        ...
                                        <p><i>Belum ada File KTP Pasangan</i></p>
                                        <input type="file" class="form-control-file" name="file_ktp_pasangan">
                                    </div>
                                    <div id="bukunikah" class="form-group form-group-default mt-2">
                                        <label>File Buku Nikah <small class="text-danger">[pdf | Max 500Kb] </small></label>
                                        <p><i>Belum ada Buku Nikah</i></p>
                                        <input type="file" class="form-control-file" name="file_buku_nikah">
                                    </div>
                                    <div id="aktacerai" class="form-group form-group-default mt-2" hidden>
                                        <label>File Akta Cerai <small class="text-danger">[pdf | Max 500Kb] </small></label>
                                        <p><i>Belum ada Akta Cerai</i></p>
