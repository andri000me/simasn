                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_anak/tambah', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="anak" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Status pasangan">
                                                    <?php foreach($mkeluarga as $o): ?>
                                                        <option value="<?= $o['id_anak'] ?>"><?= $o['nm_anak'] ?></option>
                                                    <?php endforeach;?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="anaknm" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="anakjenkel" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Status pasangan">
                                                    <?php foreach($mkelamin as $k): ?>
                                                        <option value="<?= $k['id_kelamin'] ?>"><?= $k['nm_kelamin'] ?></option>
                                                    <?php endforeach;?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="anaknoaktalahir" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Nomor BPJS</label>
                                        <div class="col-md-9">
                                            <input type="text" name="anaknobpjs" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Tempat Lahir</label>
                                        <div class="col-md-9">
                                            <input type="text" name="anaktl" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="anaktgll" class="form-control" id="tgllahir" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="anakpekerjaan" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-3 ">Nama Ibu</label>
                                        <div class="col-md-9">
                                            <input type="text" name="ibunm" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default mt-2">
                                        <label>File Akte Lahir Anak <small class="text-danger">[pdf | Max 500Kb] </small></label>
                                        <p><i>Belum ada Akta Lahir Anak</i></p>
                                        <input type="file" class="form-control-file" name="file_akta_lahir">
                                    </div>
                                    <div class="form-group form-group-default mt-2">
                                        <label>File BPJS Anak <small class="text-danger">[pdf | Max 500Kb] </small></label>
                                        <p><i>Belum ada BPJS Anak</i></p>
