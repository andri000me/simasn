                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_cuti/tambah', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    
                                    <div class="form-group row">
                                        <label class="col-md-2 ">Tanggal Surat Cuti</label>
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tglsc" class="form-control" id="tglsc" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tglawc" class="form-control" id="tglawc" required>
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="tglakc" class="form-control" id="tglakc" required>
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="cuti" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Peran">
                                                    <?php foreach ($mcuti as $mc) : ?>
                                                        <option value="<?= $mc['id_cuti'] ?>"><?= $mc['nm_cuti'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="lamac" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Alasan Cuti</label>
                                        <div class="col-md-10">
                                            <textarea name="alasanc" class="form-control" required=""></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-default" hidden>
                                        ...
                                        <input type="file" class="form-control-file" name="file_cutis">
                                    </div>
                                    <br>
                                    <div class="row">
                                        <!-- <div class="col-md-3">
