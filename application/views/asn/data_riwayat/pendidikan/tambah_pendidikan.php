                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            <div class="col-lg-12">
                                <?= form_open_multipart('data_riwayat/update_pendidikan/tambah', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    ...
                                    <div id="jenjenp" class="form-group row" hidden>
                                            ...
                                            <select class="full-width select2-hidden-accessible" name="pendidikanj" data-init-plugin="select2" tabindex="-1" onchange="getjjgpendidikan($(this).val())" aria-hidden="true">
                                                ...
                                                <optgroup label="Pilih Peran">
                                                    <?php foreach ($mjpendidikan as $mp) : ?>
                                                        <option value="<?= $mp['id_jpendidikan'] ?>"><?= $mp['nm_jpendidikan'] ?></option>
                                                    <?php endforeach; ?>
                                                </optgroup>
                                            </select>
                                        </div>
                                    </div>
                                    <div id="jurusan" class="form-group row">
                                        <label  class="col-md-2 ">Jurusan</label>
                                        <div class="col-md-10">
                                            <input type="text" name="nmjurusan" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Nama Lembaga</label>
                                        <div class="col-md-10">
                                            <input type="text" name="lembaganm" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Nama Kepala</label>
                                        <div class="col-md-10">
                                            <input type="text" name="kepalanm" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Nomor Ijazah</label>
                                        <div class="col-md-10">
                                            <input type="text" name="ijazahno" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div id="datepicker-component" class="input-group date">
                                                <input type="text" name="lulustgl" class="form-control" id="tgllulus" required>
                                    ...
                                    <!-- <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="awalpendidikan" class="form-control" required="">
                                        </div>
                                    </div> -->
                                    <div class="form-group form-group-default ">
                                        <label>File Ijazah disatukan dengan file Transkrip <small class="text-danger">[pdf | Max 500Kb]</small></label>
                                        <p><i>Belum ada File Ijazah</i></p>
                                        <input type="file" class="form-control-file" name="file_ijazahp">
                                    </div>
                                    <!-- <div class="form-group form-group-default mt-2">
                                        <label>File transkrip <small class="text-danger">[pdf | Max 300Kb]</small></label>
                                        <p><i>Belum ada File Transkrip</i></p>
                                        <input type="file" class="form-control-file" name="file_transkripp">
                                    </div> -->
                                    <br>
                                    <div class="row">
                                        <!-- <div class="col-md-3">
