                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <address class="m-b-20 m-t-10">
                                                    <a href="<?= base_url()?>data_utama/data_pribadi"><strong>Data Pribadi</strong></a>
                                                    <table class="table table-hover">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>Agama</td><td>:</td>
                                                                <td><?= !empty($asn['nm_agama']) ? $asn['nm_agama'] : '-'  ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Status Nikah</td><td>:</td>
                                                                <td><?= !empty($asn['nm_skawin']) ? $asn['nm_skawin'] : '-'  ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Email</td><td>:</td>
                                                ...
                                                <address class="m-b-20 m-t-10">
                                                    <a href="<?= base_url()?>data_utama/data_fisik"><strong>Data Fisik</strong></a>
                                                    <table class="table table-hover">
                                                        <tbody>
                                                            <tr>
                                                    ...
                                                    <table class="table table-hover">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= !empty($asn['status_pegawai']) && $asn['status_pegawai']==1 ? 'Aktif' : 'Tidak Aktif' ?></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php 
                                                                        if($j['jenis_jabatan_id']==2){
                                                                            ...
                                                                            if($j['jenjang_jabatan']){
                                                                                $jj = explode('/',$j['jenjang_jabatan']);
                                                                                echo !empty($j['jenjang_jabatan']) ? $j['nm_jabatan'].' '.$jj[0] : 'Jabatan belum ada';
                                                                            }else{
