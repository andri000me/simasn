        ...
        <div class="page-content-wrapper ">
            ...
            <div class="content ">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <?= form_open('admin/master_data/aksi_sub_pangkat/tamba_'.$uri4, 'id="formCari"');?>
                    ...
                    <div style="overflow-x: auto;" class="col-md-12 container container-fixed-lg p-0">
                        ...
                        <table class="table table-sm table-hover table-striped bg-white table-bordered m-t-10">
                            ...
                            <tbody>
                                <?php if(count($sub_pangkat)):
                                    $no=1; foreach($sub_pangkat as $gj): ?>
                                    <tr>
                                            ...
                                            <div class="modal-content-wrapper">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <?= form_open('admin/master_data/aksi_sub_pangkat/rubah_'.$uri4.'/'.encrypt_url($gj['id_'.$uri4]) );?>
                                            ...
                                            <div class="modal-content-wrapper">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" href="<?= base_url().'admin/master_data/aksi_sub_pangkat/hapus_'.$uri4.'/'.encrypt_url($gj['id_'.$uri4]); ?>" class="btn btn-danger btn-cons pull-left inline">Yes</a>
