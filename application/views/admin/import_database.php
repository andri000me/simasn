                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="form-group form-group-default ">
                                <label>File Database <small class="text-danger">[xls | Max 300Kb]</small></label>
                                <p><i>Belum ada File Database</i></p>
                                <input type="file" class="form-control-file" name="filedatabase" ?>
                            </div>
                        </div>
                    </div>
                </div>
