                            ...
                            <div class="card-header">
                                <div class="card-title col-md-9"> 
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <?= form_open('admin/laporan/kgb_terakhir', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="ukid" id="ukid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/kgb_terakhir')">
                                        ...
                                        <div class="col-md-4">
                                            <?= form_open('admin/laporan/kgb_terakhir', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select id="golid" name="golid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/kgb_terakhir')">
                                        ...
                                        <div class="col-md-4">
                                            <div class="btn-group">
                                                <a class="btn btn-info btn-sm" type="button" href="<?= base_url('admin/laporan/kgb_terakhir/cetak') ?>">
                                                    <i class="fa fa-print"></i>&nbsp;
                                                    <span class="bold">Print</span>
                                                </a>
                                                <a class="btn btn-success btn-sm" type="button" href="<?= base_url('admin/laporan/kgb_terakhir/unduh') ?>">
                    ...
                    <div class=" container-fluid w-100  container-fixed-lg bg-white">
                        <div class="card card-transparent">
                            <div class="card-block">
                                <table id="kgb" class="display w-100 table-bordered table-striped" >
                                    <thead class="W-100">
                                        <tr>
                                            ...
                                            <!-- <th class="text-nowrap text-center">KGB Berikutnya</th> -->
                                        </tr>
                                    </thead>
                                    <tbody class="w-100">
                                    </tbody>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#kgb').DataTable( {
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?= site_url('admin/laporan/get_kgb') ?>",
                    "type": "POST",
                    "data": function ( data ) {
                        ...
                        // data.search = $('#kgb_filter input').val();
                    }
                },
                columnDefs: [{
                    "targets": [0],
