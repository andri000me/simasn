        ...
        <div class="page-content-wrapper ">
            ...
            <div class="content ">
                ...
                <div class="col-md-12">
                    ...
                    <label>
                        <h4><b>REKAPITULASI BERDASARKAN MASA KERJA DAN JENIS KELAMIN</b></h4>
                    </label>
                        ...
                        <table class="table table-sm table-hover table-striped table-responsive table-bordered">
                            <thead class="bg-info-lighter">
                                <tr>
                                    ...
                                    <th class="text-black text-nowrap text-center p-2" colspan="21">
                                        <center>MASA KERJA DAN JENIS KELAMIN</center>
                                    </th>
                                ...
                                <tr>
                                    <th class="text-black text-nowrap text-center p-2" colspan="2">
                                        <center>
                                            <=5 Thn</th> <th class="text-black text-nowrap text-center p-2" rowspan="2">Jml
                                        </center>
                                    </th>
                                    <th class="text-black text-nowrap text-center p-2" colspan="2">
                                        <center>6-10 Thn</center>
                                    </th>
                                    <th class="text-black text-nowrap text-center p-2" rowspan="2">Jml</th>
                                    <th class="text-black text-nowrap text-center p-2" colspan="2">
                                        <center>11-15 Thn</center>
                                    </th>
                                    <th class="text-black text-nowrap text-center p-2" rowspan="2">Jml</th>
                                    <th class="text-black text-nowrap text-center p-2" colspan="2">
                                        <center>16-20 Thn</center>
                                    </th>
                                    <th class="text-black text-nowrap text-center p-2" rowspan="2">Jml</th>
                                    <th class="text-black text-nowrap text-center p-2" colspan="2">
                                        <center>21-25 Thn</center>
                                    </th>
                                    <th class="text-black text-nowrap text-center p-2" rowspan="2">Jml</th>
                                    <th class="text-black text-nowrap text-center p-2" colspan="2">
                                        <center>26-30 Thn</center>
                                    </th>
                                    <th class="text-black text-nowrap text-center p-2" rowspan="2">Jml</th>
                                    <th class="text-black text-nowrap text-center p-2" colspan="2">
                                        <center>> 30 Thn</center>
                                    </th>
                                    <th class="text-black text-nowrap text-center p-2" rowspan="2">Jml</th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap p-2 text-center" >17</td>
                                    <td class="text-nowrap p-2 text-center" >38</td>
                                    <td class="text-nowrap p-2 text-center" >11</td>
                                    <td class="text-nowrap p-2 text-center" >7</td>
                                    <td class="text-nowrap p-2 text-center" >18</td>
                                    <td class="text-nowrap p-2 text-center" >2</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap p-2 text-center" >42</td>
                                    <td class="text-nowrap p-2 text-center" >27</td>
                                    <td class="text-nowrap p-2 text-center" >182</td>
                                    <td class="text-nowrap p-2 text-center" >209</td>
                                    <td class="text-nowrap p-2 text-center" >68</td>
                                    <td class="text-nowrap p-2 text-center" >196</td>
                                    <td class="text-nowrap p-2 text-center" >264</td>
                                    <td class="text-nowrap p-2 text-center" >27</td>
                                    <td class="text-nowrap p-2 text-center" >104</td>
                                    ...
                                    <td class="text-nowrap p-2 text-center" >1</td>
                                    <td class="text-nowrap p-2 text-center" >2</td>
                                    <td class="text-nowrap p-2 text-center" >711</td>
                                </tr>
                                <tr>
                                    <td class="text-nowrap p-2 text-center" >3</td>
                                    ...
                                    <td class="text-nowrap p-2 text-center" >65</td>
                                    <td class="text-nowrap p-2 text-center" >95</td>
                                    <td class="text-nowrap p-2 text-center" >127</td>
                                    <td class="text-nowrap p-2 text-center" >253</td>
                                    <td class="text-nowrap p-2 text-center" >380</td>
                                    <td class="text-nowrap p-2 text-center" >249</td>
                                    <td class="text-nowrap p-2 text-center" >557</td>
                                    <td class="text-nowrap p-2 text-center" >806</td>
                                    <td class="text-nowrap p-2 text-center" >233</td>
                                    <td class="text-nowrap p-2 text-center" >386</td>
                                    <td class="text-nowrap p-2 text-center" >619</td>
                                    <td class="text-nowrap p-2 text-center" >143</td>
                                    <td class="text-nowrap p-2 text-center" >227</td>
                                    <td class="text-nowrap p-2 text-center" >370</td>
                                    <td class="text-nowrap p-2 text-center" >83</td>
                                    <td class="text-nowrap p-2 text-center" >156</td>
                                    <td class="text-nowrap p-2 text-center" >239</td>
                                    <td class="text-nowrap p-2 text-center" >2</td>
                                    <td class="text-nowrap p-2 text-center" >7</td>
                                    <td class="text-nowrap p-2 text-center" >9</td>
                                    <td class="text-nowrap p-2 text-center" >2518</td>
                                </tr>
                                <tr>
                                    <td class="text-nowrap p-2 text-center" >4</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap p-2 text-center" >27</td>
                                    <td class="text-nowrap p-2 text-center" >13</td>
                                    <td class="text-nowrap p-2 text-center" >40</td>
                                    <td class="text-nowrap p-2 text-center" >18</td>
                                    <td class="text-nowrap p-2 text-center" >21</td>
                                    <td class="text-nowrap p-2 text-center" >39</td>
                                    <td class="text-nowrap p-2 text-center" >17</td>
