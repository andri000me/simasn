                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap p-2 text-center"><?= $v['laki_agama1'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['wanita_agama1'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= ($v['laki_agama1'] + $v['wanita_agama1']) ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['laki_agama2'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['wanita_agama2'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= ($v['laki_agama2'] + $v['wanita_agama2']) ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['laki_agama3'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['wanita_agama3'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= ($v['laki_agama3'] + $v['wanita_agama3']) ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['laki_agama4'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['wanita_agama4'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= ($v['laki_agama4'] + $v['wanita_agama4']) ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['laki_agama5'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['wanita_agama5'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= ($v['laki_agama5'] + $v['wanita_agama5']) ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['laki_agama6'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= $v['wanita_agama6'] ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= ($v['laki_agama6'] + $v['wanita_agama6']) ?></td>
                                        <td class="text-nowrap p-2 text-center"><?= ($v['laki_agama4'] + $v['wanita_agama1']+$v['laki_agama1'] + $v['wanita_agama2']+$v['laki_agama2'] + $v['wanita_agama3']+$v['laki_agama3'] + $v['wanita_agama4'] + $v['laki_agama4'] + $v['wanita_agama5'] + $v['laki_agama5'] + $v['wanita_agama6'] + $v['laki_agama6']) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                <?php endforeach; ?>
