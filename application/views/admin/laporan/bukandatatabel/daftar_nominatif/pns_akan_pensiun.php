                        ...
                        <table class="table table-sm table-hover table-striped table-responsive table-bordered">
                            <thead class="bg-info-lighter">
                                <tr>
                                    ...
                                    <th class="text-black text-nowrap text-center p-2" rowspan="2">BATAS USIA PENSIUN</th>
                                    <th class="text-black text-nowrap text-center p-2" rowspan="2">TMT PENSIUN</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-nowrap p-2">08-06-1960</td>
                                    ...
                                    <td class="text-nowrap p-2">30</td>
                                    <td class="text-nowrap p-2">5</td>
                                    <td class="text-nowrap p-2">60</td>
                                    <td class="text-nowrap p-2">01-02-2023</td>
