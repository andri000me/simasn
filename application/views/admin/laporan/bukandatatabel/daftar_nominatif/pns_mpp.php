        ...
        <div class="page-content-wrapper ">
            ...
            <div class="content ">
                ...
                <div class="col-md-12">
                    ...
                    <div <div style="overflow-x: auto;" class=" col-md-12 container container-fixed-lg bg-white p-0">
                        ...
                        <table class="table table-sm table-hover table-striped bg-white table-bordered m-t-10">
                            <thead class="bg-info-lighter">
                                <tr>
                                    ...
                                    <th class="text-black text-nowrap text-center p-2" rowspan="2">Tanggal MPP</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap p-2"><?= $a['golongan'] ?></td>
                                    ...
                                    <td class="text-nowrap p-2"><?= $a['nm_unitkerja'] ?></td>
