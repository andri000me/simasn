                        ...
                        <table class="table table-sm table-hover table-striped table-responsive table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap p-2">Pengadministrasi Umum Sub Bagian Tata Usaha UPTD Puskesmas Kecamatan Moncongloe</td>
                                    <td class="text-nowrap p-2">Fungsional Pelaksana</td>
                                    <td class="text-nowrap p-2">22-08-2019</td>
                                    <td class="text-nowrap p-2">0</td>
                                    <td class="text-nowrap p-2">0</td>
                                    <td class="text-nowrap p-2"><?= !empty($a['nm_unitkerja']) ? $a['nm_unitkerja'] : '-' ?></td>
                                    <td class="text-nowrap p-2"></td>
                                    <td class="text-nowrap p-2"></td>
                                    <td class="text-nowrap p-2">30/kpts/bkpsdm/880/XII/2019</td>
                                    <!-- <td class="text-nowrap p-2">31-12-2009</td> -->
                                    <td class="text-nowrap p-2"></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
