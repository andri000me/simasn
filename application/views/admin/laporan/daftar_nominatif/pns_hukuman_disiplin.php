    ...
    <div class="page-container ">
        ...
        <div class="page-content-wrapper ">
            ...
            <div class="content ">
                ...
                <div class="col-md-12">
                    <label>
                        <h4><b>EKSPOR PNS HUKUMAN DISIPLIN</b></h4>
                    </label>
                        ...
                        <div class="card card-transparent">
                            <div class="card-header">
                                <div class="card-title col-md-9"> 
                                    <div class="row">
                                        <div class="col-md-6">
                                            <?= form_open('admin/laporan/search_pns/pns_aktif', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="ukid" id="ukid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/search_pns/pns_aktif')">
                    ...
                    <div class=" container-fluid   container-fixed-lg bg-white">
                        <div class="card card-transparent">
                            <div class="card-block table-responsive">
                                <table id="pnsaktif" class="display table-bordered table-striped" cellspasing="0" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-nowrap text-center" colspan="3">Hukuman Disiplin</th>
                                            <th class="text-nowrap text-center" colspan="2">SK Hukuman</th>
                                            <th class="text-nowrap text-center" rowspan="2">Unit Kerja</th>
                                            <!-- <th class="text-nowrap text-center" rowspan="2">Ket</th> -->
                                        </tr>
                                        <tr>
                                            ...
                                            <th class="text-center text-nowrap">Nama Hukuman</th>
                                            <th class="text-center text-nowrap">Jenis Hukuman</th>
                                            <th class="text-center text-nowrap">TMT Hukuman</th>
                                            <th class="text-center text-nowrap">Nomor SK</th>
                                            <th class="text-center text-nowrap">Tanggal SK</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
