    ...
    <div class="page-container ">
        ...
        <div class="page-content-wrapper ">
            ...
            <div class="content ">
                ...
                <div class="col-md-12">
                    <label>
                        <h4><b>DAFTAR NOMINATIF ASN BERDASARKAN JENJANG PENDIDIKAN</b></h4>
                    </label>
                            ...
                            <div class="card-header">
                                <div class="card-title col-md-9"> 
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <?= form_open('admin/laporan/daftar_nominatif/pns_pendidikan_s1', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="ukid" id="ukid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/daftar_nominatif/pns_pendidikan_s1')">
                                        ...
                                        <div class="col-md-3">
                                            <?= form_open('admin/laporan/daftar_nominatif/pns_pendidikan_s1', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="vamas" id="vamas" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/daftar_nominatif/pns_pendidikan_s1')">
                                        ...
                                        <div class="col-md-3">
                                            <?= form_open('admin/laporan/daftar_nominatif/pns_pendidikan_s1', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="jedu" id="jedu" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/daftar_nominatif/pns_pendidikan_s1')">
                                                        <option value="" required>-- Pilih Jenis Pendidikan-- </option>
                                                        <?php foreach($edu as $e): ?>
                                                            <option value="<?= encrypt_url($e['id_jpendidikan']) ?>" <?= !empty($jedu_aktif) && $jedu_aktif==$e['id_jpendidikan'] ? 'selected':'' ?>><?= $e['nm_jpendidikan'] ?></option>
                                                        <?php endforeach;?>
                                                    </select>
                                                </div>
                                            <?= form_close() ?>
                    ...
                    <!-- END card -->
                    <!-- START card Tabel -->
                    <div class="col-md-12 container w-100 container-fixed-lg bg-white p-0">
                        <div class="card card-transparent">
                            <div class="card-block table-responsive">
                                <table id="pnss1" class="display table-bordered table-striped" cellspasing="0" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-nowrap text-center p-1" colspan="2">Pangkat Terakhir</th>
                                            <th class="text-nowrap text-center p-1" colspan="3">Jabatan</th>
                                            <th class="text-nowrap text-center p-1" colspan="2">Pendidikan</th>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-nowrap text-center p-1">Nama Jabatan</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#pnss1').DataTable( {
                ...
                "ajax": {
                    "url": "<?= site_url('admin/laporan/daftar_nominatif_pns_s1') ?>",
                    "type": "POST",
                    "data": function ( data ) {
                        data.ukid = $('#ukid').val();
