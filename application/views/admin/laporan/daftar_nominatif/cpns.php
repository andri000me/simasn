                            ...
                            <div class="card-header">
                                <div class="card-title col-md-9"> 
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <?= form_open('admin/laporan/daftar_nominatif/cpns', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="ukid" id="ukid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/daftar_nominatif/cpns')">
                                        ...
                                        <div class="col-md-4">
                                            <?= form_open('admin/laporan/daftar_nominatif/cpns', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="vamas" id="vamas" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/daftar_nominatif/cpns')">
                    ...
                    <div class=" container-fluid w-100  container-fixed-lg bg-white">
                        <div class="card card-transparent">
                            <div class="card-block">
                                <table id="cpns" class="display table-bordered table-striped table-responsive" cellspasing="0" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-nowrap text-center p-1" colspan="2">Jabatan</th>
                                            <th class="text-nowrap text-center p-1" colspan="2">
                                                Masa Kerja
                                            </th>
                                            <th class="text-nowrap text-center p-1" colspan="4">
                                                Pendidikan
                                            </th>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-nowrap text-center p-1">TMT CPNS</th>
                                            <th class="text-nowrap text-center p-1">Nomor SK</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#cpns').DataTable( {
                ...
                "ajax": {
                    "url": "<?= site_url('admin/laporan/daftar_nominatif_cpns') ?>",
                    "type": "POST",
                    "data": function ( data ) {
