    ...
    <div class="page-container ">
        ...
        <div class="page-content-wrapper ">
            ...
            <div class="content ">
                ...
                <div class="col-md-12">
                    <label>
                        <h4><b>ASN AKTIF YANG AKAN PENSIUN 1 TAHUN (MPP)</b></h4>
                    </label>
                            ...
                            <div class="card-header">
                                <div class="card-title col-md-9"> 
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <?= form_open('admin/laporan/daftar_nominatif/pns_mpp', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="ukid" id="ukid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/daftar_nominatif/pns_mpp')">
                                        ...
                                        <div class="col-md-4">
                                            <?= form_open('admin/laporan/daftar_nominatif/pns_mpp', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="vamas" id="vamas" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/daftar_nominatif/pns_mpp')">
                    ...
                    <div class=" container-fluid w-100  container-fixed-lg bg-white">
                        <div class="card card-transparent">
                            <div class="card-block  table-responsive w-100">
                                <table id="pnsmpp" class="display table-bordered table-striped" cellspasing="0" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-nowrap text-center p-1" rowspan="2">Stastus</th>
                                            <th class="text-nowrap text-center p-1" rowspan="2">Status PNS</th>
                                            <th class="text-nowrap text-center p-1" rowspan="2">No SK</th>
                                            <th class="text-nowrap text-center p-1" rowspan="2">Tanggal MPP</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#pnsmpp').DataTable( {
                ...
                "ajax": {
                    "url": "<?= site_url('admin/laporan/daftar_nominatif_pns_mpp') ?>",
                    "type": "POST",
                    "data": function ( data ) {
                        // data.search = $('#pnsmpp_filter input').val();
                        data.ukid = $('#ukid').val();
