				...
				<tbody>
					<?php if(!empty($pns)):?>
						...
						<tr>
							...
							<td class="text-nowrap" style='mso-number-format:\@'> <?= $p['nip'];?> </td>
							...
							<td class="text-nowrap" style='mso-number-format:\@'> <?= !empty($p['tmt_pangkat']) ? date('d-m-Y', strtotime($p['tmt_pangkat'])) : '-';?> </td>
							<td class="text-nowrap"> <?= $jabatan;?> </td>
							<td class="text-nowrap"> <?= !empty($p['eselon']) ? $p['eselon'] : '';?> </td>
							<td class="text-nowrap" style='mso-number-format:\@'> <?= !empty($p['tmt_jabatan']) ? date('d-m-Y', strtotime($p['tmt_jabatan'])) : '-';?> </td>
