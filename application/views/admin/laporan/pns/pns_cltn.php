    ...
    <div class="page-container ">
        ...
        <div class="page-content-wrapper ">
            ...
            <div class="content ">
                ...
                <div class="col-md-12">
                    <label>
                        <h4><b>ASN AKTIF YANG CUTI LUAR TANGGUNGAN NEGARA (CLTN)</b></h4>
                    </label>
                            ...
                            <div class="card-header">
                                <div class="card-title col-md-9"> 
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <?= form_open('admin/laporan/search_pns/pns_cltn', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="ukid" id="ukid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/search_pns/pns_cltn')">
                                        ...
                                        <div class="col-md-4">
                                            <?= form_open('admin/laporan/search_pns/pns_cltn', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select id="golid" name="golid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/search_pns/pns_cltn')">
                                        ...
                                        <div class="col-md-4">
                                            <div class="btn-group">
                                                <a class="btn btn-info btn-sm" type="button" href="<?= base_url('admin/laporan/pns/pns_cltn/cetak') ?>">
                                                    <i class="fa fa-print"></i>&nbsp;
                                                    <span class="bold">Print</span>
                                                </a>
                                                <a class="btn btn-success btn-sm" type="button" href="<?= base_url('admin/laporan/pns/pns_cltn/unduh') ?>">
                    ...
                    <div class=" container-fluid w-100  container-fixed-lg bg-white">
                        <div class="card card-transparent">
                            <div class="card-block">
                                <table id="pnscltn" class="display table-bordered table-striped table-responsive" style="width:100%">
                                    <thead>
                                        <tr>
            ...
            $('#pnscltn').DataTable( {
                ...
                "ajax": {
                    ...
                    "data": function ( data ) {
                        ...
                        // data.search = $('#pnscltn_filter input').val();
                    }
                },
                columnDefs: [{
                    targets: "_all",
