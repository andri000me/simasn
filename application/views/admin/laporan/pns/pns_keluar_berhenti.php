                            ...
                            <div class="card-header">
                                <div class="card-title col-md-9"> 
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <?= form_open('admin/laporan/search_pns/pns_keluar_berhenti', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select name="ukid" id="ukid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/search_pns/pns_keluar_berhenti')">
                                        ...
                                        <div class="col-md-4">
                                            <?= form_open('admin/laporan/search_pns/pns_keluar_berhenti', 'id="filter" role="form"'); ?>
                                                <div class="form-group">
                                                    <select id="golid" name="golid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/search_pns/pns_keluar_berhenti')">
                                        ...
                                        <div class="col-md-4">
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-info btn-sm" type="button" href="<?= base_url('admin/laporan/pns/pns_keluar_berhenti/cetak') ?>">
                                                    <i class="fa fa-print"></i>&nbsp;
                                                    <span class="bold">Print</span>
                                                </a>
                                                <a class="btn btn-success btn-sm" type="button" href="<?= base_url('admin/laporan/pns/pns_keluar_berhenti/unduh') ?>">
                    ...
                    <div class=" container-fluid w-100  container-fixed-lg bg-white">
                        <div class="card card-transparent">
                            <div class="card-block">
                                <table id="pnskeluarberhenti" class="display table-bordered table-striped table-responsive" style="width:100%">
                                    <thead>
                                        <tr>
            ...
            $('#pnskeluarberhenti').DataTable( {
                ...
                "ajax": {
                    ...
                    "data": function ( data ) {
                        ...
                        // data.search = $('#pnskeluarberhenti_filter input').val();
                    }
                },
                columnDefs: [{
                    targets: "_all",
