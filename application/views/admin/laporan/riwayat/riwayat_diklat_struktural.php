...
<body class="fixed-header horizontal-menu horizontal-app-menu ">
                        ...
                        <div class="card-header">
                            <div class="card-title col-md-9"> 
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <?= form_open('admin/laporan/riwayat/riwayat_diklat_struktural', 'id="filter" role="form"'); ?>
                                            <div class="form-group">
                                                <select name="ukid" id="ukid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/riwayat/riwayat_diklat_struktural')">
                                    ...
                                    <div class="col-md-4">
                                        <?= form_open('admin/laporan/riwayat/riwayat_diklat_struktural', 'id="filter" role="form"'); ?>
                                            <div class="form-group">
                                                <select name="vamas" id="vamas" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/riwayat/riwayat_diklat_struktural')">
                                                    <option value="" required>-- Pilih Jenis Diklat -- </option>
                                                    <?php foreach($distruk as $u): ?>
                                                        <option value="<?= encrypt_url($u['id_jenis_diklat']) ?>" <?= !empty($vamas_aktif) && $vamas_aktif==$u['id_jenis_diklat'] ? 'selected':'' ?>><?= $u['jenis_diklat'] ?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                        <?= form_close() ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="btn-group">
                                            <a class="btn btn-info btn-sm" type="button" href="<?= base_url('admin/laporan/riwayat/riwayat_diklat_struktural/cetak') ?>">
                                                <i class="fa fa-print"></i>&nbsp;
                                                <span class="bold">Print</span>
                                            </a>
                                            <a class="btn btn-success btn-sm" type="button" href="<?= base_url('admin/laporan/riwayat/riwayat_diklat_struktural/unduh') ?>">
                ...
                <div class=" container-fluid w-100  container-fixed-lg bg-white">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block">
                            <table id="dikstruktural" class="display table-bordered table-striped" style="width:100%">
                                <thead>
                                    <tr>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#dikstruktural').DataTable( {
                "responsive" : true,
                "processing": true,
                "serverSide": true,
                "searching" : true,
                "ajax": {
                    "url": "<?= site_url('admin/laporan/get_riwayat_dikstruktural') ?>",
                    "type": "POST",
                    "data": function ( data ) {
