                        ...
                        <div class="card-header">
                            <div class="card-title col-md-9"> 
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <?= form_open('admin/laporan/riwayat/riwayat_pendidikan', 'id="filter" role="form"'); ?>
                                            <div class="form-group">
                                                <select name="ukid" id="ukid" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/riwayat/riwayat_pendidikan')">
                                    ...
                                    <div class="col-md-3">
                                        <?= form_open('admin/laporan/riwayat/riwayat_pendidikan', 'id="filter" role="form"'); ?>
                                            <div class="form-group">
                                                <select id="jedu" name="jedu" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/riwayat/riwayat_pendidikan')">
                                                    <option value="" required>-- Pilih Jenis Pendidikan --</option>
                                                    <option value="1" <?= !empty($jedu_aktif) && $jedu_aktif==1 ? 'selected':'' ?>>Akademik</option>
                                                    <option value="2" <?= !empty($jedu_aktif) && $jedu_aktif==2 ? 'selected':'' ?>>Profesi</option>
                                                </select>
                                            </div>
                                        <?= form_close() ?>
                                    </div>
                                    <div class="col-md-3">
                                        <?= form_open('admin/laporan/riwayat/riwayat_pendidikan', 'id="filter" role="form"'); ?>
                                            <div class="form-group">
                                                <select id="vamas" name="vamas" class="full-width" data-init-plugin="select2" onchange="this.form.submit('admin/laporan/riwayat/riwayat_pendidikan')">
                                                    <option value="" required>-- Pilih Jenjang Pendidikan --</option>
                                                    <?php foreach($edu as $g): ?>
                                                        <option value="<?= encrypt_url($g['id_jpendidikan']) ?>" <?= !empty($vamas_aktif) && $vamas_aktif==$g['id_jpendidikan'] ? 'selected':'' ?>><?= $g['nm_jpendidikan'] ?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                        <?= form_close() ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="btn-group">
                                            <a class="btn btn-info btn-sm" type="button" href="<?= base_url('admin/laporan/riwayat/riwayat_pendidikan/cetak') ?>">
                                                <i class="fa fa-print"></i>&nbsp;
                                                <span class="bold">Print</span>
                                            </a>
                                            <a class="btn btn-success btn-sm" type="button" href="<?= base_url('admin/laporan/riwayat/riwayat_pendidikan/unduh') ?>">
                ...
                <div class=" container-fluid w-100  container-fixed-lg bg-white">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block">
                            <table id="pendidikan" class="display table-bordered table-striped table-responsive" style="width:100%">
                                <thead>
                                    <tr>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#pendidikan').DataTable( {
                ...
                "searching" : true,
                "ajax": {
                    "url": "<?= site_url('admin/laporan/get_riwayat_pendidikan') ?>",
                    "type": "POST",
                    "data": function ( data ) {
