                ...
                <div class=" container-fluid w-100  container-fixed-lg">
                    ...
                    <div class="col-lg-12">
                        <div class="row column-seperation">
                            ...
                            <div class="col-lg-6">
                                <?= form_open('setting/ubah_username', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    <div class="form-group row">
                                        <label  class="col-md-2 ">Username</label>
                                        <div class="col-md-10">
                                            <input type="text" name="usernm" class="form-control" value="<?= $user['username'] ?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                <?= form_open('setting/ubah_password', 'class="form-horizontal"', 'role="form"', 'autocomplete="off"');?>
                                    <div class="form-group row">
                                        <label for="pass1"  class="col-md-2 ">Input Password Lama</label>
                                        <div class="col-md-10">
                                            <input type="password" id="pass1" name="paswl" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="pass1"  class="col-md-2 ">Input Password Baru</label>
                                        <div class="col-md-10">
                                            <input type="password" id="pass1" name="pasw" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="pass2"  class="col-md-2 ">Konfirmasi Baru</label>
                                        <div class="col-md-10">
                                            <input type="password" id="pass2" name="kpasw" class="form-control" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
  ...
  `  <script src="<?= base_url(); ?>assets/asn/plugins/modernizr.custom.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        var password = document.getElementById("pass1"), 
            confirm_p = document.getElementById("pass2");
